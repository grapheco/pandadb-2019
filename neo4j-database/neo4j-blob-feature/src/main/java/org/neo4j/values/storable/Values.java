...
public final class Values
{
    ...
    public static BlobValue blobValue( BlobEntry value )
    {
        return new BlobValue( value );
    }

    public static BlobArray blobArray( BlobEntry... value )
    {
    ...
    private static Value arrayValue( Object[] value )
    {
        ...
        {
            return blobArray( copy( value, new BlobEntry[value.length] ) );
        }
        if ( value instanceof String[] )
        {
