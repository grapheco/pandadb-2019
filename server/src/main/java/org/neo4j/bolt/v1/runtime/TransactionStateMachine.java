...
public class TransactionStateMachine implements StatementProcessor
{
            ...
            throws KernelException
    {
        ...
        try
        {
            ...
            // pandaDB
            int curVersion = _getLocalDataVersion() + 1;
    ...
    // pandaDB
    private int _getLocalDataVersion() {
        return PNodeServerContext.getJsonDataLog().getLastVersion();
    }

    // pandaDB
    private void _writeDataLog(int curVersion, String cypher) {
        DataLogDetail logItem = new DataLogDetail(curVersion, cypher);
