...
public class DriverFactory
{
    ...
    //NOTE: pandadb
    public static final String PANDA_URI_SCHEME = "panda";
    //NOTE
                                         ...
                                         EventExecutorGroup eventExecutorGroup, RoutingSettings routingSettings, RetryLogic retryLogic, MetricsProvider metricsProvider, Config config )
    {
        try
        {
            ...
            switch ( scheme )
            {
                ...
                //NOTE: pandadb
                case PANDA_URI_SCHEME:
                    return PandaDriver.create(securityPlan, address, connectionPool, eventExecutorGroup, routingSettings, retryLogic, metricsProvider, config);
                //NOTE
                default:
