...
import org.neo4j.kernel.impl.blob.CustomDatabaseLifecyclePluginService;
...
public class GraphDatabaseFacadeFactory
{
            ...
            final GraphDatabaseFacade graphDatabaseFacade )
    {
        ...
        //blob support
        platform.life.add( new CustomDatabaseLifecyclePluginService( procedures, storeDir, config, databaseInfo ) );
