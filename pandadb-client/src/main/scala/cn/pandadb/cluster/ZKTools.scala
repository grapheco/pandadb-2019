...
import cn.pandadb.log.Logging
import org.apache.curator.framework.{CuratorFramework, CuratorFrameworkFactory}
import org.apache.curator.framework.recipes.cache.{NodeCache, NodeCacheListener, PathChildrenCache, PathChildrenCacheListener, TreeCache, TreeCacheListener}
import org.apache.curator.retry.ExponentialBackoffRetry
import org.apache.zookeeper.{CreateMode, ZooDefs}
import org.slf4j.Logger


class ZKTools(zkServerAddress: String, pandadbZkDir: String) extends Logging{
  private val logger = getLogger(this.getClass)
  private val pandaZkDir: String = pandadbZkDir.replaceAll("/{2,}", "/")
  private var curator: CuratorFramework = CuratorFrameworkFactory.newClient(zkServerAddress, new ExponentialBackoffRetry(1000, 3))
  curator.start()
